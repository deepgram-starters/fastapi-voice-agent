...
FastAPI demo app for Deepgram Voice Agent.
...
```
feat(fastapi-voice-agent): add diarization support
fix(fastapi-voice-agent): resolve WebSocket close handling
refactor(fastapi-voice-agent): simplify session endpoint
